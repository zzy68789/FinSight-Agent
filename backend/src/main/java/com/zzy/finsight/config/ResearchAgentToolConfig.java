...
public class ResearchAgentToolConfig {
    ...
    @Bean
    ResearchTool getCompanyProfileTool(AShareMasterDataProvider provider) {
    ...
    @Bean
    ResearchTool getFinancialStatementsTool(TushareMarketDataProvider provider) {
        return new FinancialProviderResearchTool(
    ...
    @Bean
    ResearchTool getMarketSnapshotTool(PublicMarketDataProvider provider) {
        return new FinancialProviderResearchTool(
                "get_market_snapshot",
    ...
    @Bean
    ResearchTool retrieveUploadedReportsTool(UploadedReportProvider provider) {
        return new FinancialProviderResearchTool(
