...
public class StockReportRunner {
    ...
    void run(
        ...
        try {
            ...
            if (reusableReport.isPresent()) {
                ...
                meterRegistry.counter("drai.stock.report.cache", "result", "hit").increment();
                completeTask(taskId, threadId, progress, "PASS", 0, true);
                return;
            }
            meterRegistry.counter("drai.stock.report.cache", "result", "miss").increment();
            ...
            meterRegistry.counter("drai.stock.workflow.task", "result", "failed").increment();
    ...
    private void completeTask(
        ...
        meterRegistry.counter("drai.stock.workflow.task", "result", "completed").increment();
    ...
    private void publish(
        ...
        Timer.builder("drai.stock.workflow.stage.duration")
                .tag("stage", step)
