...
@Service
public class TaskRuntimeStateService {
    private static final String TASK_STATUS_KEY = "drai:task:%d:status";
    private static final String TASK_PROGRESS_KEY = "drai:task:%d:progress";
    private static final String THREAD_LATEST_TASK_KEY = "drai:thread:%s:latestTask";
    private static final String SSE_LAST_EVENT_KEY = "drai:sse:%d:last-event";
    ...
    public TaskRuntimeStateService(
            StringRedisTemplate redisTemplate,
            ObjectMapper objectMapper,
            @Value("${drai.redis.runtime-ttl:PT24H}") Duration runtimeTtl
    ) {
